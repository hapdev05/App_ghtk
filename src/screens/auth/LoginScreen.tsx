  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <View className="pl-12">
        <Text className="text-4xl font-bold pl-4 pt-20">Đăng nhập SFlash</Text>
      </View>
      ...
      <View className="px-12 mt-10 space-y-6">
        ...
        <TouchableOpacity>
          <Text className="text-blue-500 text-right mr-4" onPress={()=>navigation.navigate("Forgot")}>Quên mật khẩu?</Text>
        </TouchableOpacity>
        ...
        <View className="flex flex-row justify-center mt-6">
          ...
          <TouchableOpacity>
            <Text className="text-blue-500 font-semibold" onPress={()=>navigation.navigate('Register')}>Đăng ký</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
